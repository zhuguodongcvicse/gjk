  ...
  <div>
    <div class="page-helper" v-if="showPageHelper">
      <div class="page-list">
        ...
        <span class="page-item" v-model="currentSize">2条/页</span>
        <span class="page-item" :class="{'disabled': currentPage === 1}"  @click="prevPage"><i class="el-icon-thirdleft" ></i></span>
        ...
        <span class="page-item" :class="{'disabled': currentPage === totalPage}" @click="nextPage"><i class="el-icon-thirdright" ></i></span>
