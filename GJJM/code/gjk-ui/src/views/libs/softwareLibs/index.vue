<template>
  <div class="app-container calendar-list-container libs_softwarelibs_index_14s">
    <basic-container>
...
import { testLib, testfile, getAlgorithmFilePath, readAlgorithmfile } from "@/api/libs/threelibs";
