<template>
<el-form :model="paramzy" ref="paramzy"  label-width="100px" class="demo-dynamic admin_dispose_showselectsingle_14s">
  <el-form-item>
...
export default {
  ...
  methods: {
    editParamxz() {
      ...
      //标识空间赋值
       this.$emit("model-change", this.paramzy.xmlEntitys,1);
    },
