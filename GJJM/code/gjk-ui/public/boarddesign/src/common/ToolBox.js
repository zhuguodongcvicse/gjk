 ...
 /*           var basicNodes = [{
    ...
    /*        var innerGroups = [{prefix: 'Q-', name: 'basic.nodes', displayName: getI18NString('Basic Nodes'), images: basicNodes}, {
        ...
        _createGroup: function (groupInfo) {
            ...
            if(imageInfo.clientProperties.infName != null){
                var sortName = imageInfo.clientProperties.infName;
            }else{
                var sortName = imageInfo.clientProperties.chipName;
            } 
                   // console.log('imageInfo.clientProperties.infName',imageInfo);
                    //var sortLength = 10;
