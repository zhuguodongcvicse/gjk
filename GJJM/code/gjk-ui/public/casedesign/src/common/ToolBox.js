        ...
        _createGroup: function (groupInfo) {
            ...
            forEach(images, function (imageInfo, name) {
              ...
              //  imageDiv.setAttribute('title', tooltip);
                ...
                $(item).find("div").addClass("intro");
                console.log("item",item)
                console.log("$(item).find(div)",$(item).children("div")) */
                // console.log("imageDiv",imageDiv)
                /* $(".group__item").each(function(){
                    $(this).css("max-width","60px");
                    $(this).find("div").
                        max-height 60px
                }); */
                // console.log("imageInfo.clientProperties", imageInfo)
              var boardName =  imageInfo.clientProperties.boardName;
            //   console.log("sonStr.datas",imageInfo.clientProperties.boardName);
                if(imageInfo.br){
