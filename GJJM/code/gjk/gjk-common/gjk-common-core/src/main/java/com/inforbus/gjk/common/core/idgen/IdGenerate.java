 ...
 */
package com.inforbus.gjk.common.core.idgen;
...
//	private static IdWorker idWorker = new IdWorker(-1, -1);
	 ...
	 * 获取（当前时间毫秒+6位随机数）的id
	 * 
	 * @Title: MillsAndRandomId
	 * @Description:
	 * @Author CVICSE-COMMON
	 * @DateTime 2019年6月12日 下午9:17:17
	 * @return
	 */
	public static String millsAndRandomId() {
		String res = "";
		long t1 = System.currentTimeMillis();
		long t2 = Math.round(Math.random() * 899999 + 100000);
		res = Long.toString(t1) + Long.toString(t2);
		return res;
	}
...
//	}
	...
	public static void main(String[] args) {
		...
		System.out.println(millsAndRandomId());
		System.out.println("2147483647");
		// System.out.println(Math.round(Math.random()*899999+100000));
