if(! function(t, e) {
		...
		function x(t) {
			var e = J,
				n = Re[t];
			return n || (n = b(t, e), "none" !== n && n || (Me = (Me || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = Me[0].contentDocument, e.write(), e.close(), n = b(t, e), Me.detach()), Re[t] = n), n
		}
		...
		function $(t, e) {
			for(var n, i, o, r = [], s = 0, a = t.length; a > s; s++) i = t[s], i.style && (r[s] = ve.get(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && ke(i) && (r[s] = ve.access(i, "olddisplay", x(i.nodeName)))) : (o = ke(i), "none" === n && o || ve.set(i, "olddisplay", o ? n : Z.css(i, "display"))));
		...
		function L(t, e, n) {
			...
			})), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], c = Z.css(t, "display"), u = "none" === c ? ve.get(t, "olddisplay") || x(t.nodeName) : c, "inline" === u && "none" === Z.css(t, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", h.always(function() {
			...
			if(Z.isEmptyObject(p)) "inline" === ("none" === c ? x(t.nodeName) : c) && (f.display = c);
			else {
				g ? "hidden" in g && (d = g.hidden) : g = ve.access(t, "fxshow", {}), r && (g.hidden = !d), d ? Z(t).show() : h.done(function() {
					Z(t).hide()
				}), h.done(function() {
					var e;
					ve.remove(t, "fxshow");
				...
				for(i in p) s = A(d ? g[i] : 0, i, h), i in g || (g[i] = s.start, d && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
			}
		}
		...
		function F(t, e, n) {
			var i, o, r = 0,
				...
				l = function() {
					if(o) return !1;
					for(var e = Ye || D(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++) c.tweens[s].run(r);
		...
		function R(t, e, n, i) {
			...
			if(Z.isArray(e)) Z.each(e, function(e, o) {
				n || Sn.test(t) ? i(t, o) : R(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
			});
		...
		var oe = function(t) {
			function e(t, e, n, i) {
				var o, r, s, a, l, c, h, f, d, g;
				if((e ? e.ownerDocument || e : R) !== L && A(e), e = e || L, n = n || [], a = e.nodeType, "string" != typeof t || !t || 1 !== a && 9 !== a && 11 !== a) return n;
				if(!i && F) {
					if(11 !== a && (o = ye.exec(t)))
						if(s = o[1]) {
							if(9 === a) {
					...
					if(w.qsa && (!P || !P.test(t))) {
						if(f = h = M, d = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
							for(c = S(t), (h = e.getAttribute("id")) ? f = h.replace(xe, "\\$&") : e.setAttribute("id", f), f = "[id='" + f + "'] ", l = c.length; l--;) c[l] = f + p(c[l]);
			...
			function f(t, e, n) {
				...
				return e.first ? function(e, n, r) {
					...
					if(s) {
						...
						for(; e = e[i];)
							if(1 === e.nodeType || o) {
								if(l = e[M] || (e[M] = {}), (a = l[i]) && a[0] === W && a[1] === r) return c[2] = a[2];
				...
				return o && !o[M] && (o = v(o)), r && !r[M] && (r = v(r, s)), i(function(i, s, a, l) {
					...
					if(i) {
						if(r || t) {
							...
							for(u = b.length; u--;)(h = b[u]) && (c = r ? te(i, h) : p[u]) > -1 && (i[c] = !(s[c] = h))
						}
					...
					if(n = C.relative[t[a].type]) u = [f(d(u), n)];
						...
						if(n = C.filter[t[a].type].apply(null, t[a].matches), n[M]) {
							...
							return v(a > 1 && d(u), a > 1 && p(t.slice(0, a - 1).concat({
								value: " " === t[a - 2].type ? "*" : ""
							})).replace(le, "$1"), n, i > a && y(t.slice(a, i)), o > i && y(t = t.slice(i)), o > i && p(t))
						}
						u.push(n)
					}
				return d(u)
				...
				var o = n.length > 0,
					...
					s = function(i, s, a, l, c) {
						var u, h, p, f = 0,
							...
							w = b.length;
						for(c && (N = s !== L && s); d !== w && null != (u = b[d]); d++) {
							if(r && u) {
								for(h = 0; p = t[h++];)
									if(p(u, s, a)) {
										l.push(u);
			...
			var x, w, C, k, T, S, E, $, N, D, j, A, L, H, F, P, q, O, I, M = "sizzle" + 1 * new Date,
				R = t.document,
				W = 0,
				B = 0,
				_ = n(),
			...
			w = e.support = {}, T = e.isXML = function(t) {
				...
				return i !== L && 9 === i.nodeType && i.documentElement ? (L = i, H = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", ke, !1) : n.attachEvent && n.attachEvent("onunload", ke)), F = !T(i), w.attributes = o(function(t) {
					return t.className = "i", !t.getAttribute("className")
				}), w.getElementsByTagName = o(function(t) {
					return t.appendChild(i.createComment("")), !t.getElementsByTagName("*").length
				}), w.getElementsByClassName = ve.test(i.getElementsByClassName), w.getById = o(function(t) {
					return H.appendChild(t).id = M, !i.getElementsByName || !i.getElementsByName(M).length
				...
				}, q = [], P = [], (w.qsa = ve.test(i.querySelectorAll)) && (o(function(t) {
					H.appendChild(t).innerHTML = "<a id='" + M + "'></a><select id='" + M + "-\f]' msallowcapture=''><option selected=''></option></select>", t.querySelectorAll("[msallowcapture^='']").length && P.push("[*^$]=" + ne + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || P.push("\\[" + ne + "*(?:value|" + ee + ")"), t.querySelectorAll("[id~=" + M + "-]").length || P.push("~="), t.querySelectorAll(":checked").length || P.push(":checked"), t.querySelectorAll("a#" + M + "+*").length || P.push(".#.+[+~]")
				}), o(function(t) {
				...
				})), (w.matchesSelector = ve.test(O = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && o(function(t) {
					w.disconnectedMatch = O.call(t, "div"), O.call(t, "[s!='']:x"), q.push("!=", se)
				}), P = P.length && new RegExp(P.join("|")), q = q.length && new RegExp(q.join("|")), e = ve.test(H.compareDocumentPosition), I = e || ve.test(H.contains) ? function(t, e) {
					...
					return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === R && I(R, t) ? -1 : e === i || e.ownerDocument === R && I(R, e) ? 1 : D ? te(D, t) - te(D, e) : 0 : 4 & n ? -1 : 1)
				} : function(t, e) {
					if(t === e) return j = !0, 0;
					var n, o = 0,
						r = t.parentNode,
						...
						l = [t],
						c = [e];
					if(!r || !a) return t === i ? -1 : e === i ? 1 : r ? -1 : a ? 1 : D ? te(D, t) - te(D, e) : 0;
					if(r === a) return s(t, e);
				...
				if((t.ownerDocument || t) !== L && A(t), n = n.replace(he, "='$1']"), !(!w.matchesSelector || !F || q && q.test(n) || P && P.test(n))) try {
					var i = O.call(t, n);
				...
				var n = C.attrHandle[e.toLowerCase()],
					i = n && Q.call(C.attrHandle, e.toLowerCase()) ? n(t, e, !F) : void 0;
				...
				var e, n = [],
					i = 0,
					o = 0;
				if(j = !w.detectDuplicates, D = !w.sortStable && t.slice(0), t.sort(U), j) {
				...
				preFilter: {
					...
					PSEUDO: function(t) {
						var e, n = !t[6] && t[2];
						return de.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && pe.test(n) && (e = S(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
					}
				},
				filter: {
					TAG: function(t) {
					...
					CHILD: function(t, e, n, i, o) {
						...
						return 1 === i && 0 === o ? function(t) {
							...
							var c, u, h, p, f, d, g = r !== s ? "nextSibling" : "previousSibling",
								m = e.parentNode,
							...
							if(m) {
								...
								if(d = [s ? m.firstChild : m.lastChild], s && y) {
									for(u = m[M] || (m[M] = {}), c = u[t] || [], f = c[0] === W && c[1], p = c[0] === W && c[2], h = f && m.childNodes[f]; h = ++f && h && h[g] || (p = f = 0) || d.pop();)
										if(1 === h.nodeType && ++p && h === e) {
											u[t] = [W, f, p];
											break
										}
								} else if(y && (c = (e[M] || (e[M] = {}))[t]) && c[0] === W) p = c[1];
								else
									for(;
										(h = ++f && h && h[g] || (p = f = 0) || d.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++p || (y && ((h[M] || (h[M] = {}))[t] = [W, p]), h !== e)););
			...
			return h.prototype = C.filters = C.pseudos, C.setFilters = new h, S = e.tokenize = function(t, n) {
				...
				if(n = n || [], 1 === h.length) {
					if(r = h[0] = h[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && w.getById && 9 === e.nodeType && F && C.relative[r[1].type]) {
				...
				return(c || E(t, h))(i, e, !F, n, be.test(t) && u(e.parentNode) || e), n
			}, w.sortStable = M.split("").sort(U).join("") === M, w.detectDuplicates = !!j, A(), w.sortDetached = o(function(t) {
		...
		Z.extend({
			...
			Z.fn[t] = function(n, i) {
				...
				return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = Z.filter(i, o)), this.length > 1 && (pe[t] || Z.unique(o), he.test(t) && o.reverse()), this.pushStack(o)
			}
		});
		var fe = /\S+/g,
			de = {};
		...
		Z.event = {
			...
			add: function(t, e, n, i, o) {
				var r, s, a, l, c, u, h, p, f, d, g, m = ve.get(t);
				if(m)
					for(n.handler && (r = n, n = r.handler, o = r.selector), n.guid || (n.guid = Z.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(e) {
						...
						}), e = (e || "").match(fe) || [""], c = e.length; c--;) a = De.exec(e[c]) || [], f = g = a[1], d = (a[2] || "").split(".").sort(), f && (h = Z.event.special[f] || {}, f = (o ? h.delegateType : h.bindType) || f, h = Z.event.special[f] || {}, u = Z.extend({
						type: f,
						origType: g,
						data: i,
						handler: n,
						...
						namespace: d.join(".")
					}, r), (p = l[f]) || (p = l[f] = [], p.delegateCount = 0, h.setup && h.setup.call(t, i, d, s) !== !1 || t.addEventListener && t.addEventListener(f, s, !1)), h.add && (h.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, u) : p.push(u), Z.event.global[f] = !0)
			},
			remove: function(t, e, n, i, o) {
				var r, s, a, l, c, u, h, p, f, d, g, m = ve.hasData(t) && ve.get(t);
				if(m && (l = m.events)) {
					for(e = (e || "").match(fe) || [""], c = e.length; c--;)
						if(a = De.exec(e[c]) || [], f = g = a[1], d = (a[2] || "").split(".").sort(), f) {
							for(h = Z.event.special[f] || {}, f = (i ? h.delegateType : h.bindType) || f, p = l[f] || [], a = a[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--;) u = p[r], !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(r, 1), u.selector && p.delegateCount--, h.remove && h.remove.call(t, u));
							s && !p.length && (h.teardown && h.teardown.call(t, d, m.handle) !== !1 || Z.removeEvent(t, f, m.handle), delete l[f])
						} else
			...
			trigger: function(e, n, i, o) {
				var r, s, a, l, c, u, h, p = [i || J],
					f = G.call(e, "type") ? e.type : e,
					d = G.call(e, "namespace") ? e.namespace.split(".") : [];
				if(s = a = i = i || J, 3 !== i.nodeType && 8 !== i.nodeType && !Ne.test(f + Z.event.triggered) && (f.indexOf(".") >= 0 && (d = f.split("."), f = d.shift(), d.sort()), c = f.indexOf(":") < 0 && "on" + f, e = e[Z.expando] ? e : new Z.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = d.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : Z.makeArray(n, [e]), h = Z.event.special[f] || {}, o || !h.trigger || h.trigger.apply(i, n) !== !1)) {
					if(!o && !h.noBubble && !Z.isWindow(i)) {
						for(l = h.delegateType || f, Ne.test(l + f) || (s = s.parentNode); s; s = s.parentNode) p.push(s), a = s;
						a === (i.ownerDocument || J) && p.push(a.defaultView || a.parentWindow || t)
					}
					for(r = 0;
						(s = p[r++]) && !e.isPropagationStopped();) e.type = r > 1 ? l : h.bindType || f, u = (ve.get(s, "events") || {})[e.type] && ve.get(s, "handle"), u && u.apply(s, n), u = c && s[c], u && u.apply && Z.acceptData(s) && (e.result = u.apply(s, n), e.result === !1 && e.preventDefault());
					return e.type = f, o || e.isDefaultPrevented() || h._default && h._default.apply(p.pop(), n) !== !1 || !Z.acceptData(i) || c && Z.isFunction(i[f]) && !Z.isWindow(i) && (a = i[c], a && (i[c] = null), Z.event.triggered = f, i[f](), Z.event.triggered = void 0, a && (i[c] = a)), e.result
				}
			},
			dispatch: function(t) {
				t = Z.event.fix(t);
			...
			fix: function(t) {
				...
				var e, n, i, o = t.type,
					r = t,
					s = this.fixHooks[o];
				for(s || (this.fixHooks[o] = s = $e.test(o) ? this.mouseHooks : Ee.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new Z.Event(r), e = i.length; e--;) n = i[e], t[n] = r[n];
		...
		Ie.optgroup = Ie.option, Ie.tbody = Ie.tfoot = Ie.colgroup = Ie.caption = Ie.thead, Ie.th = Ie.td, Z.extend({
			...
			buildFragment: function(t, e, n, i) {
				for(var o, r, s, a, l, c, u = e.createDocumentFragment(), h = [], p = 0, f = t.length; f > p; p++)
					if(o = t[p], o || 0 === o)
					...
					Z.merge(h, r.childNodes), r = u.firstChild, r.textContent = ""
			...
			domManip: function(t, e) {
				...
				var n, i, o, r, s, a, l = 0,
					...
					p = t[0],
					g = Z.isFunction(p);
				if(g || c > 1 && "string" == typeof p && !Y.checkClone && Fe.test(p)) return this.each(function(n) {
					var i = u.eq(n);
				...
				if(c && (n = Z.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
					for(o = Z.map(v(n, "script"), f), r = o.length; c > l; l++) s = n, l !== h && (s = Z.clone(s, !0, !0), r && Z.merge(o, v(s, "script"))), e.call(this[l], s, l);
					if(r)
						for(a = o[o.length - 1].ownerDocument, Z.map(o, d), l = 0; r > l; l++) s = o[l], Pe.test(s.type || "") && !ve.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Oe, "")))
				}
				return this
			}
		}), Z.each({
		...
		Z.extend({
			...
			style: function(t, e, n, i) {
				if(t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
					var o, r, s, a = Z.camelCase(e),
						l = t.style;
					return e = Z.cssProps[a] || (Z.cssProps[a] = k(l, a)), s = Z.cssHooks[e] || Z.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e] : (r = typeof n, "string" === r && (o = Ue.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(Z.css(t, e)), r = "number"), void(null != n && n === n && ("number" !== r || Z.cssNumber[a] || (n += "px"), Y.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l[e] = n))))
				}
			},
			css: function(t, e, n, i) {
				var o, r, s, a = Z.camelCase(e);
				return e = Z.cssProps[a] || (Z.cssProps[a] = k(t.style, a)), s = Z.cssHooks[e] || Z.cssHooks[a], s && "get" in s && (o = s.get(t, !0, n)), void 0 === o && (o = w(t, e, i)), "normal" === o && e in Qe && (o = Qe[e]), "" === n || n ? (r = parseFloat(o), n === !0 || Z.isNumeric(r) ? r || 0 : o) : o
			}
			...
			Z.cssHooks[e] = {
				...
				set: function(t, n, i) {
					var o = i && _e(t);
					return T(t, n, i ? S(t, e, i, "border-box" === Z.css(t, "boxSizing", !1, o), o) : 0)
				}
			}
			...
			}, We.test(t) || (Z.cssHooks[t + e].set = T)
		}), Z.fn.extend({
			css: function(t, e) {
		...
		Z.extend({
			...
			ajax: function(t, e) {
				...
				if(i = q(xn, h, e, w)) {
					w.readyState = 1, c && f.trigger("ajaxSend", [w, h]), h.async && h.timeout > 0 && (a = setTimeout(function() {
						w.abort("timeout")
					}, h.timeout));
					try {
						b = 1, i.send(v, n)
		...
		Z.param = function(t, e) {
			...
			serializeArray: function() {
				return this.map(function() {
					...
					var t = this.type;
					return this.name && !Z(this).is(":disabled") && Nn.test(this.nodeName) && !$n.test(t) && (this.checked || !Te.test(t))
				}).map(function(t, e) {
					var n = Z(this).val();
		...
		Z.ajaxSetup({
			...
			var o, r, s, a = e.jsonp !== !1 && (Fn.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && Fn.test(e.data) && "data");
			return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = Z.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Fn, "$1" + o) : e.jsonp !== !1 && (e.url += (hn.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function() {
		...
		Z.offset = {
			...
			offset: function(t) {
				...
				var e, n, i = this[0],
					...
					r = i && i.ownerDocument;
				return r ? (e = r.documentElement, Z.contains(e, i) ? (typeof i.getBoundingClientRect !== Se && (o = i.getBoundingClientRect()), n = W(r), {
		...
		return Z.noConflict = function(e) {
			return t.$ === Z && (t.$ = In), e && t.jQuery === Z && (t.jQuery = On), Z
	...
	n.VERSION = "3.2.0", n.DEFAULTS = {
		...
		if(this.hasContent() && this.enabled) {
			...
			if(l) {
				...
				s = "bottom" == s && c.top + c.height + h - d.scroll > d.height ? "top" : "top" == s && c.top - d.scroll - h < 0 ? "bottom" : "right" == s && c.right + u > d.width ? "left" : "left" == s && c.left - u < d.left ? "right" : s, o.removeClass(p).addClass(s)
			}
		...
		var h = u.left ? 2 * u.left - o + l : 2 * u.top - r + c,
			p = u.left ? "left" : "top",
			f = u.left ? "offsetWidth" : "offsetHeight";
		i.offset(e), this.replaceArrow(h, i[0][f], p)
...
function(t) {
	...
	t.fn.borderLayout = function() {
		...
		return this.each(function() {
			function e() {
				c && (b = c._data.width, b && (b = o(b, h, c._data["min-width"], c._data["max-width"]), T = b, x = parseInt(c._data.left) || 0, x && (w -= x, T += x), w -= b, n(c, {
					top: k,
					left: x,
					width: b,
					height: C
				}))), l && (b = l._data.width, b && (b = o(b, h, l._data["min-width"], l._data["max-width"]), x = parseInt(l._data.right) || 0, x && (w -= x), w -= b, n(l, {
					top: k,
					right: x,
					width: b,
					height: C
			...
			function i() {
				s && (b = s._data.height, b && (b = o(b, p, s._data["min-height"], s._data["max-height"]), C -= b, k = b, n(s, {
					top: 0,
					left: T,
					width: w,
					height: b
				}))), a && (b = a._data.height, b && (b = o(b, p, a._data["min-height"], a._data["max-height"]), C -= b, n(a, {
					bottom: 0,
					left: T,
					height: b,
					width: w
			...
			for(var r, s, a, l, c, u = t(this).hasClass("layout--h"), h = this.clientWidth, p = this.clientHeight, f = 0, d = this.children; f < d.length;) {
				var g = d[f++],
	...
	"use strict";
	var e = function(n, i, o, r, s) {
		this.fallbackValue = o ? o && "undefined" != typeof o.h ? o : this.value = {
			h: 0,
			s: 0,
			b: 0,
			a: 1
		} : null, this.fallbackFormat = r ? r : "rgba", this.hexNumberSignPrefix = s === !0, this.value = this.fallbackValue, this.origFormat = null, this.predefinedColors = i ? i : {}, this.colors = t.extend({}, e.webColors, this.predefinedColors), n && ("undefined" != typeof n.h ? this.value = n : this.setColor(String(n))), this.value || (this.value = {
			h: 0,
			s: 0,
			b: 0,
			a: 1
	...
	e.webColors = {
		...
		toHex: function(t, e, n, i) {
			...
			if(this.rgbaIsTransparent(o)) return "transparent";
			var r = (this.hexNumberSignPrefix ? "#" : "") + ((1 << 24) + (parseInt(o.r) << 16) + (parseInt(o.g) << 8) + parseInt(o.b)).toString(16).slice(1);
			return r
		},
		...
		toAlias: function(t, e, n, i) {
			var o, r = 0 === arguments.length ? this.toHex() : this.toHex(t, e, n, i),
				s = "alias" === this.origFormat ? r : this.toString(this.origFormat, !1);
			for(var a in this.colors)
				if(o = this.colors[a].toLowerCase().trim(), o === r || o === s) return a;
			return !1
		},
		...
		HSLtoRGB: function(t, e, n, i) {
			...
			var r = 2 * n - o,
				...
				h = Math.round(255 * this.HueToRGB(r, o, l));
			return [c, u, h, this._sanitizeNumber(i)]
		},
		parse: function(e) {
			if(0 === arguments.length) return !1;
			var n, i, o = this,
				r = !1,
				s = "undefined" != typeof this.colors[e];
			return s && (e = this.colors[e].toLowerCase().trim()), t.each(this.stringParsers, function(t, a) {
				var l = a.re.exec(e);
				return n = l && a.parse.apply(o, [l]), !n || (r = {}, i = s ? "alias" : a.format ? a.format : o.getValidFallbackFormat(), r = i.match(/hsla?/) ? o.RGBtoHSB.apply(o, o.HSLtoRGB.apply(o, n)) : o.RGBtoHSB.apply(o, n), r instanceof Object && (r.format = i), !1)
			}), r
		},
		...
		toString: function(t, n) {
			t = t || this.origFormat || this.fallbackFormat, n = n || !1;
			var i = !1;
			switch(t) {
				case "rgb":
					return i = this.toRGB(), this.rgbaIsTransparent(i) ? "transparent" : "rgb(" + i.r + "," + i.g + "," + i.b + ")";
				case "rgba":
					return i = this.toRGB(), "rgba(" + i.r + "," + i.g + "," + i.b + "," + i.a + ")";
				case "hsl":
				...
				case "hex":
					return this.toHex();
				case "alias":
					return i = this.toAlias(), i === !1 ? this.toString(this.getValidFallbackFormat()) : n && !(i in e.webColors) && i in this.predefinedColors ? this.predefinedColors[i] : i;
				default:
					return i
			}
		},
	...
	var n = {
		...
		i = function(e, i) {
			...
			var o = this.picker = t(this.options.template);
			if(this.options.customClass && o.addClass(this.options.customClass), o.addClass(this.options.inline ? "colorpicker-inline colorpicker-visible" : "colorpicker-hidden"), this.options.horizontal && o.addClass("colorpicker-horizontal"), -1 === ["rgba", "hsla", "alias"].indexOf(this.format) && this.options.format !== !1 && "transparent" !== this.getValue() || o.addClass("colorpicker-with-alpha"), "right" === this.options.align && o.addClass("colorpicker-right"), this.options.inline === !0 && o.addClass("colorpicker-no-arrow"), this.options.colorSelectors) {
				var r = this,
					s = r.picker.find(".colorpicker-selectors");
				s.length > 0 && (t.each(this.options.colorSelectors, function(e, n) {
					var i = t("<i />").addClass("colorpicker-selectors-color").css("background-color", n).data("class", e).data("alias", e);
					i.on("mousedown.colorpicker touchstart.colorpicker", function(e) {
						e.preventDefault(), r.setValue("alias" === r.format ? t(this).data("alias") : t(this).css("background-color"))
					}), s.append(i)
				}), s.show().addClass("colorpicker-visible"))
			}
			o.on("mousedown.colorpicker touchstart.colorpicker", t.proxy(function(t) {
				t.target === t.currentTarget && t.preventDefault()
			}, this)), o.find(".colorpicker-saturation, .colorpicker-hue, .colorpicker-alpha").on("mousedown.colorpicker touchstart.colorpicker", t.proxy(this.mousedown, this)), o.appendTo(this.container ? this.container : t("body")), this.input !== !1 && (this.input.on({
	...
	i.Color = e, i.prototype = {
		...
		show: function(e) {
			this.isDisabled() || (this.picker.addClass("colorpicker-visible").removeClass("colorpicker-hidden"), this.reposition(), t(window).on("resize.colorpicker", t.proxy(this.reposition, this)), !e || this.hasInput() && "color" !== this.input.attr("type") || e.stopPropagation && e.preventDefault && (e.stopPropagation(), e.preventDefault()), !this.component && this.input || this.options.inline !== !1 || t(window.document).on({
		...
		hide: function(e) {
			return("undefined" == typeof e || !e.target || !(t(e.currentTarget).parents(".colorpicker").length > 0 || t(e.target).parents(".colorpicker").length > 0)) && (this.picker.addClass("colorpicker-hidden").removeClass("colorpicker-visible"), t(window).off("resize.colorpicker", this.reposition), t(window.document).off({
		...
		updateInput: function(t) {
			return t = t || this.color.toString(this.format, !1), this.input !== !1 && (this.input.prop("value", t), this.input.trigger("change")), t
		},
		...
		createColor: function(t) {
			return new e(t ? t : null, this.options.colorSelectors, this.options.fallbackColor ? this.options.fallbackColor : this.color, this.options.fallbackFormat, this.options.hexNumberSignPrefix)
		},
		getValue: function(t) {
		...
		var n = Array.prototype.slice.call(arguments, 1),
			...
			s = this.each(function() {
				var o = t(this),
					s = o.data("colorpicker"),
					a = "object" == typeof e ? e : {};
				s || (s = new i(this, a), o.data("colorpicker", s)), "string" == typeof e ? t.isFunction(s[e]) ? r = s[e].apply(s, n) : (n.length && (s[e] = n[0]), r = s[e]) : r = o
			});
		return o ? r : s
