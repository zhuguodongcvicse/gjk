      ...
      <avue-crud ref="crud"
        ...
        <template slot-scope="scope"
          ...
          <el-button type="primary"
                     ...
                     size="small"
                     plain
                     @click="storageApplys(scope.row,scope.index)">入库
          </el-button>
          <el-button type="primary"
                     disabled="true"
                     ...
                     size="small"
                     plain
                     @click="handleRku(scope.row,scope.index)">已入库
          </el-button>
        </template>
      </avue-crud>
    </basic-container>
...
<script>
  import {fetchList, getObj, addObj, putObj, delObj, editStructObj,rKuStructObj} from '@/api/libs/structlibs'
