<template>
  ...
  >
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="goStorageOfChip('form')">入库</el-button>
    </span>
  </el-dialog>
</template>
...
<script>
    ...
    import { updateChip } from "@/api/libs/hardwarelibchip";
                    ...
                    if (valid) {
                        ...
                        if (this.infWillToStorage.applyState === "0" || this.infWillToStorage.applyState == null) {
                            ...
                            saveApproval(approval).then(Response => {
                                ...
                                //修改构件审批状态成已提交申请
                                updateChip(infTemp).then(Response => {
                                    // this.$parent.getList();
                                    this.reload();
                                    this.$message({
