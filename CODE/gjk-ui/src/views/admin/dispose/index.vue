          ...
          <div class="dispose_grid_form">
              ...
              <div class="div2">
                <div class="dispose_grid_tit">
                  ...
                  <el-button @click="addDomain" type="primary" plain icon="el-icon-plus" size="small">新增</el-button>
                </div>
                <label></label>
                      ...
                      <el-form label-width="82px">
                        <el-form-item label="构件名">
                          <el-select
                            ...
                            >
                              <span class="fl_14s">{{ item.label }}</span>
                              <span class="fr_14s fontsize1"
                              >{{ item.value }}</span>
                            </el-option>
                          </el-select>
                          <el-button class="dispose_grid_del" plain @click.prevent="removeDomain(domain)">删除</el-button>
                        </el-form-item>
                      </el-form>
                      </div>
                    </el-form-item>
