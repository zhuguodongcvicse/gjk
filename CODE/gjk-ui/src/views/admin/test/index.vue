<template>
  <div class="app-container calendar-list-container admin_menu_index_14s admin_test_index_14s">
    <basic-container>
      <div class="filter-container">
        <el-button-group>
          <el-button type="primary" v-if="testManager_btn_add" icon="plus" @click="handlerAdd">添加</el-button>
          <el-button type="primary" v-if="testManager_btn_edit" icon="edit" @click="handlerEdit">编辑</el-button>
          <el-button
            type="primary"
            v-if="testManager_btn_del"
            icon="delete"
            @click="handleDelete"
          >删除</el-button>
        </el-button-group>
        ...
        <el-col :span="16" class="menu_main_right_14s">
          <el-card class="box-card">
            <el-form :label-position="labelPosition" label-width="80px" :model="form" ref="form">
              <el-form-item label="测试库名" prop="name">
                <el-input v-model="form.name" :disabled="formEdit" placeholder="请输入测试库名"></el-input>
              </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [{ required: true, message: "请输入测试库名", trigger: "blur" }]
      },
      labelPosition: "right",
      form: {
        name: undefined,
  ...
  methods: {
    handleDrop(draggingNode, dropNode, dropType, ev) {
      ...
      if (dropType === "inner") {
        ...
        var testId = draggingNode.data.id;
