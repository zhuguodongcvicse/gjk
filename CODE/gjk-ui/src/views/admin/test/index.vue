      ...
      <div class="filter-container">
        <el-button-group>
          <el-button type="primary"
                     v-if="testManager_btn_add"
                     icon="plus"
                     @click="handlerAdd">添加
          </el-button>
          <el-button type="primary"
                     v-if="testManager_btn_edit"
                     icon="edit"
        ...
        <el-col :span="16" class="menu_main_right_14s">
          <el-card class="box-card">
            <el-form :label-position="labelPosition"
                     ...
                     :model="form"
                     ref="form">             
              <el-form-item label="测试库名"
                            prop="name">
                <el-input v-model="form.name"
                          :disabled="formEdit"
                          placeholder="请输入测试库名"></el-input>
              </el-form-item>                    
...
<script>
  import {addObj, delObj, fetchTestTree, getObj, putObj} from '@/api/admin/test'
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          name: [
            {required: true, message: '请输入测试库名', trigger: 'blur'}
          ],
        },
        labelPosition: 'right',
        form: {
    ...
    methods: {
      handleDrop(draggingNode, dropNode, dropType, ev) {
        ...
        if(dropType==="inner"){
            ...
            var testId = dropNode.data.children[dropNode.data.children.length-1].id;
