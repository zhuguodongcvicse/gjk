        ...
        <el-col :span="16" class="menu_main_right_14s">
          <el-card class="box-card">
            <el-form :label-position="labelPosition"
                     ...
                     :model="form"
                     ref="form">                        
              <el-form-item label="平台库名"
                            prop="name">
                <el-input v-model="form.name"
                          :disabled="formEdit"
                          placeholder="请输入平台库名"></el-input>
              </el-form-item>
...
<script>
  import {addObj, delObj, fetchPlatformTrees, getObj, putObj} from '@/api/admin/platform'
    ...
    data() {
      return {
        ...
        rules: {
          ...
          name: [
            {required: true, message: '请输入平台库名', trigger: 'blur'}
          ],
        },
        labelPosition: 'right',
        form: {
    ...
    methods: {
      handleDrop(draggingNode, dropNode, dropType, ev) {
        ...
        if(dropType==="inner"){
            ...
            var platformId = dropNode.data.children[dropNode.data.children.length-1].id;
