...
public class TreeUtilAl {
	 ...
	 * @return
	 */
	public <T extends TreeNodeAl> List<T> buildByLoop(List<T> treeNodes, Object root) {
	 ...
	 * @return
	 */
	public List<AlgorithmTree> buildTreesss(List<GjkAlgorithm> gjkAlgorithms, String root) {
		...
		for (GjkAlgorithm gjkAlgorithm : gjkAlgorithms) {
			...
			node.setFilePath(gjkAlgorithm.getPermission());
			trees.add(node);
		}
		return TreeUtilAl.buildByLoop(trees, root);
	}
}
